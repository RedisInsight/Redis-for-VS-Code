...
export const ConsentsPrivacy = () => {
  ...
  return (
    <div>
      ...
      <div className="py-9">
        {l10n.t('To optimize your experience, RedisInsight uses third-party tools. All data collected is anonymized and will not be used for any purpose without your consent.')}
      </div>
