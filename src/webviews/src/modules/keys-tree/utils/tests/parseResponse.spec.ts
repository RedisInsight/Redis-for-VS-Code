...
import { parseKeysListResponse } from '../parseResponse'
...
describe('parseKeysListResponse', () => {
  ...
  it('should summarize data with initial state (standalone)', () => {
    ...
    const result = parseKeysListResponse(currentState.shardsMeta, scanResponse as any)
  ...
  it('should summarize data  with initial one (cluster)', () => {
    ...
    const result = parseKeysListResponse(currentState.shardsMeta as any, scanResponse as any)
    expect(result).toEqual({
