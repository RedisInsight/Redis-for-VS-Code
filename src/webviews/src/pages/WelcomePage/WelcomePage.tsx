  ...
  return (
    <div className={styles.container} data-testid="welcome-page">
      ...
      <div className="flex flex-col flex-grow">
        <Spacer size="m" />
        <h3>{l10n.t('About Redis for VSCode')}</h3>
        <span>{l10n.t('Take your productivity to the next level when developing with Redis or Redis Stack! Use Redis for VSCode to visualize and optimize Redis data.')}</span>
        <span>{l10n.t('A powerful desktop manager, Redis for VSCode provides an intuitive and efficient UI for Redis and Redis Stack and supports CLI interaction in a fully-featured desktop UI client.')}</span>
        <Spacer size="l" />
